...
| UX / IA / 工具类 | **ux** · **ia** · **week** · **disk** · **maintain** · **ops-deploy** · **code-stats-viz** · **pencil-design** | skill-only（无 slash） |
...
| 范围 | 标准 |
|------|------|
| 结构 | 28 skills · 3 agents · 54 rules · 10 commands · config/hooks/bin 齐全 |
