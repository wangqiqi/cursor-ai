...
| 子 id | 意图 | 入口 | rules / 命令 |
|-------|------|------|----------------|
| `git` | Git / PR / Review / 收尾 | **git** · **finish** · **review** · `babysit` · `split-to-prs` | `commit.mdc` · collaboration |
...
| PR、Review、合并请求 | **more** → **git** · **review** · **finish** · `babysit` |
| 分支收尾、merge | **finish** · **git** |
