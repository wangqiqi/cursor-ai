...
check "$CUR/skills/finish/SKILL.md"
...
check_grep_absent "$CUR" "jwplan-skill"
check_grep_absent "$CUR" "jwrun-skill"
check_grep_absent "$CUR" "master 指令"
check_grep_absent "$CUR" "saies"
check_grep_absent "$CUR/docs" "wangqiqi"
...
[[ "$pf" == "plan.md" ]] && echo "OK  jw_json_cfg plan_file=$pf" || { echo "FAIL jw_json_cfg plan_file=$pf"; FAIL=$((FAIL+1)); }
